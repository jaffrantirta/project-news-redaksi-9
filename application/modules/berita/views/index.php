...
function format_date_in($option_format, $date){
	...
	function format_date($option_format, $date){
...
<div class="container">
        <div class="col-sm-8">		
            ...
            { ?>
                ...
                <?php $this->session->set_flashdata('search', format_date(2,substr($search, 1, 7)));
            } ?>
            ...
            if(isset($page)&&$page!=0)
                $index = $index+$page;
                    ...
                    <p>
                      ...
                      <div class="well">
                      <?php echo form_open('berita/'); ?>
                        <select name="search" class="form-control" id="month">
