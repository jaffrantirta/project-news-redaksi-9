...
class Category extends MX_Controller {
    ...
    public function baca($id)
    {
        ...
        $data['about'] = $this->DataAbout->getAllData('about');
            ...
            $this->initializepagination(base_url("category/baca/$id/"),
            'berita',
            'DataAlbum',
            ...
            $data['datas'] = $this->DataBerita->getcategory($this->numOfContentsPerPage,$page,'kategori','berita','berita.id_category=kategori.id', $id);
            $data['page'] = $page;
            $data['title'] = $this->DataBerita->getSpecificData('kategori', array('id' => $id));
