        ...
        <div class="row koepoekoepoe-content" id="theRecipe">
            ...
            <div class="col-md-4">
                ...
                <div class="visible-lg visible-md">
                    <a href="<?php echo base_url().'recipes/generatePdf/'.$resep->ID_RESEP ?>"><button class="btn-lg btn-round-lg form-control btn-koepoe-action"><span
...
<div class="container recipes-sm-containere" style="padding-left: 0;padding-right: 0;">
    ...
    <hr>
    <div class="text-center">
        <button class="btn koepoekoepoe-red btn-round">LOAD MORE</button>
    </div>
    <hr>
    <script>
