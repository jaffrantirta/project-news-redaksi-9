    ...
    <div class="koepoekoepoe-banner">
        ...
        <div class="koepoekoepoe-banner-content">
            <div class="recipes-borderleft">
                <h1 class="visible-lg visible-md">Our recipes</h1>
        ...
        <div class="col-md-8 text-center">
            ...
            <div class="visible-lg visible-md">
                <a href="<?php echo base_url() ?>recipes" class="btn-lg btn-round-lg btn-recipe"
                   style="color: black; text-decoration: none;outline: none">All Recipes</a>
                <?php
                $index = 1;
                foreach ($resep_kategori as $kategori)
                {
                    echo '<a href="' . base_url() . 'recipes/by/' . $kategori->ID_RESEP_KATEGORI . '" class="btn-lg btn-round-lg btn-recipe" style="color:black; text-decoration:none;outline: none">' . $kategori->NAMA_RESEP_KATEGORI . '</a>';
                    $index++;
                    if($index==4)
                        echo '<hr>';
                    else if($index>4)
                ...
                <div class="dropdown">
                    <button class="btn-lg btn-round-lg btn-recipe" type="button" data-toggle="dropdown"
                        ...
                        if(isset($nama_kategori))
                            echo $nama_kategori->NAMA_RESEP_KATEGORI;
                        else
                            echo 'All Eecipes';?>
                    ...
                    <ul class="dropdown-menu" style="width: 80%;position: absolute;margin-left: 10%;margin-right: 10%;">
                        <li><a href="<?php echo base_url() ?>recipes/">All Recipes</a></li>
                        <?php
                        foreach ($resep_kategori as $kategori)
                        {
                            echo '<li><a href="' . base_url() . 'recipes/by/' . $kategori->ID_RESEP_KATEGORI . '">' . $kategori->NAMA_RESEP_KATEGORI . '</a></li>';
                        }
                        ?>
                    </ul>
                </div>
    ...
    <div class="for-infinite">
        ...
        if ($recipes)
        {
            if (sizeof($recipes) == 1)
            {
                ...
                echo '<button class="btn btn-round btn-transparent">' . $recipes[0]->NAMA_RESEP_KATEGORI . '</button>';
