<div class="mycontainer container-sm">
    <div class="koepoekoepoe-banner">
        <img class="content-banner" height="500px" width="100%" src="<?php echo base_url(); ?>/public/images/header_stories_content.jpg">
        ...
        <div class="row koepoekoepoe-content" style="padding:5% 5%;">
            <div class="col-md-12">
                <div class="row" style="padding:30px 0px 20px 30px;">
                    ...
                    <p class="visible-lg visible-md"><span class="fa fa-user"></span>&nbsp;by <strong><?php echo $story->PENULIS ?></strong>&nbsp;&bull;&nbsp;<?php
                        $yrdata= strtotime($story->CREATED_AT);
                        echo date('d M, Y', $yrdata);
                        ?>&nbsp;&bull;&nbsp;<span class="fb-comments-count" data-href="<?php echo current_url() ?>"></span> Comments</p>
                    <p class="visible-sm visible-xs"><span class="fa fa-user"></span>&nbsp;by <strong><?php echo $story->PENULIS ?></strong><br><br>June
                        20, 2017&nbsp;&bull;&nbsp;<span class="fb-comments-count" data-href="<?php echo current_url() ?>"></span> Comments</p>
                </div>
                <div class="row">
                    <div class="col-md-3 visible-lg visible-md">
                        <button class="btn btn-round story-love-btn"><span class="fa fa-heart-o"></span>&nbsp;
                            <?php echo $story->LIKE_COUNT_STORY == null ? 0:$story->LIKE_COUNT_STORY  ?>
                        </button>
                        <br><br>
                        <div class="input-group form-control" style="border:none; width: 70%">
                            ...
                            <a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=<?php echo base_url() . 'stories/details/' . $story->ID_STORY ?>" class="btn btn-round-right sosmed-share" style="background: rgba(46,77,167,.80); color: white;">
                        ...
                        <div class="input-group form-control" style="border:none; width: 70%">
                            ...
                            <a target="_blank" href="https://twitter.com/intent/tweet?text=<?php echo base_url() . 'stories/details/' . $story->ID_STORY ?>" class="btn btn-round-right sosmed-share" style="background: rgba(54,185,255,.80); color: white;">
                        ...
                        <div class="input-group form-control" style="border:none; width: 70%">
                            ...
                            <button class="btn btn-md btn-round-right"
                    ...
                    <div class="col-md-9">
                        ...
                        <hr>
                        <button class="btn btn-round form-control"><strong><span class="fa fa-comment"></span>&nbsp;VIEW
                                COMMENTS</strong></button>
                        <br><br>
                        <a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=<?php echo base_url() . 'stories/details/' . $story->ID_STORY ?>" class="btn btn-round form-control sosmed-share"
                                style="background: rgba(46,77,167,1.00); color: white"><strong><span
                                        class="fa fa-facebook"></span>&nbsp;SHARE THIS ARTICLE</strong></a>
                        <br><br>
                        <a target="_blank" href="https://twitter.com/intent/tweet?text=<?php echo base_url() . 'stories/details/' . $story->ID_STORY ?>" class="btn btn-round form-control sosmed-share"
