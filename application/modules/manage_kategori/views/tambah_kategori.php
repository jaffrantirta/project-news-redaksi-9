...
<div class="container">
    <div class="container" style="background: #f5f5f5;">
        <h3>Tambah Data</h3>
        <br>
        <?php echo form_open_multipart('manage_kategori/tambahkategori/')?>
        <div class="row">
            <div class="col-md-2">
                <label>Title</label>
            </div>
            <div class="col-md-10">
                <input name="title_" type="text" class="form-control" value="<?php echo $this->session->flashdata('title_'); ?>"/>
            </div>
        </div>
        <br>
        <div class="row">
