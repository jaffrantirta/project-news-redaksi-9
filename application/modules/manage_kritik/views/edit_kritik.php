...
<div class="container">
    <div class="container" style="background: #f5f5f5;">
        <h3>Edit Kritik</h3>
        <br>
        <?php echo form_open_multipart('manage_kritik/editkritik/'.$data->id); ?>
        <div class="row">
            <div class="col-md-2">
        ...
        <br>
         <div class="row">
            ...
            <div class="col-md-10">
                <?php echo $this->ckeditor->editor("respon",$data->respon); ?>
            </div>
        </div>
        <br>
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <div class='input-group date' id='datetimepicker2'>
                    <input name="respon_date" type='text' class="form-control" VALUE="<?php echo $data->respon_date ?>" />
                    <span class="input-group-addon">
                        <span class="glyphicon glyphicon-calendar"></span>
                    </span>
                </div>
