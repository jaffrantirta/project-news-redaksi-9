<div class="container">
    <ol class="breadcrumb">
        <li>List</li>
        <li><a href="<?php echo base_url() . 'manage_situs/' ?>">Data</a></li>
        <li class="active">Add</li>
    </ol>
</div>
<div class="container">
    <div class="container" style="background: #f5f5f5;">
        <h3>Edit Situs Terkait</h3>
        <br>
        <?php echo form_open_multipart('manage_situs/editsitus/'.$data->id); ?>
        <div class="row">
            <div class="col-md-2">
                <label>Title</label>
            </div>
        ...
        <div class="col-md-12 text-center">
             <a href="<?php echo base_url() . 'manage_situs/' ?>" class="btn btn-warning">Cancel</a>
