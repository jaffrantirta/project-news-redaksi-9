...
<div class="container">
    <h3><span class="glyphicon glyphicon-file"></span>Redaksi9 TV</h3>
    <ol class="breadcrumb">
        <li>List</li>
        <li class="active">Data</li>
        <li><a href="<?php echo base_url() . 'manage_tv/tambahtv' ?>">Add</a></li>
    </ol>
    <div class="row">
        <div class="col-md-6">
            <?php if (isset($search))
    ...
    <table class="table table-striped">
        ...
        if (isset($datas))
        {
            ...
            foreach ($datas as $data)
            {
                echo '<tr>';
                echo '<td>' . $index . '</td>';
                echo '<td><a href="' . base_url() . 'manage_tv/edittv/' . $data->id . '" class="btn btn-primary">Edit</a>&nbsp;&nbsp;&nbsp;<button onclick="confirmDelete('.$data->id.',\'tv\')" class="btn btn-danger">Delete</button></td>';
